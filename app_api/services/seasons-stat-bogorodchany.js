...
ПСГ Богородчанське.Температура т.р. За вологою	903031
ПСГ Богородчанське.Температура т.р. За вуглеводнями	903031
ПСГ Богородчанське. Густина газу, кг/м3	903031
ПСГ Богородчанське. Теплота згоряння вища, кВт*год/м3 (0/25)	903031
ПСГ Богородчанське. Теплота згоряння вища, кВт*год/м3 (20/25)	903031
ПСГ Богородчанське. ВТВ загалом	3012131
ПСГ Богородчанське. ВТВ дкс паливний газ	903017
ПСГ Богородчанське	903031	901
ПСГ Богородчанське	903031	902
...
async function create (season) {
    const objectPsg = 903031;
    const objectFxp = 903031;
    const objectPG = 903017;
    const vtvInject = 3012131;
    const vtvWith = 3012131;

    const sendGts = 7001304;
    const getGts = 7001305;
