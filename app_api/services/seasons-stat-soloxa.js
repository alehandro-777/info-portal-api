...
ПСГ Солохівське.Температура т.р. За вологою	901024	29
ПСГ Солохівське.Температура т.р. За вуглеводнями	901024	13
ПСГ Солохівське. Густина газу, кг/м3	901024	14
ПСГ Солохівське. Теплота згоряння вища, кВт*год/м3 (0/25)	901024	202
ПСГ Солохівське. Теплота згоряння вища, кВт*год/м3 (20/25)	901024	539
ПСГ Солохівське. ВТВ загалом відбор	1100411	63
ПСГ Солохівське. ВТВ загалом закач	1100301	63
ПСГ Солохівське. ВТВ дкс паливний газ	901024	30

ПСГ Солохівське	901031	902
...
async function create (season) {
    const objectPsg = 901031;
    const objectFxp = 901024;
    const objectPG = 901024;
    const vtvInject = 1100301;
    const vtvWith = 1100411;

    const sendGts = 7001314;
    const getGts = 7001315;
