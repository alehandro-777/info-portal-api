...
ПСГ Краснопопівське.Температура т.р. За вологою	905031	29
ПСГ Краснопопівське.Температура т.р. За вуглеводнями	905031	13
ПСГ Краснопопівське. Густина газу, кг/м3	905031	14
ПСГ Краснопопівське. Теплота згоряння вища, кВт*год/м3 (0/25)	905031	202
ПСГ Краснопопівське. Теплота згоряння вища, кВт*год/м3 (20/25)	905031	539
ПСГ Краснопопівське. ВТВ дкс паливний газ	905021	30

ПСГ Червонопопівське	905031	902
ПСГ Червонопопівське	905031	902
...
async function create (season) {
    const objectPsg = 905031;
    const objectFxp = 905031;
    const objectPG = 905031;
    const vtvInject = 0;
    const vtvWith = 0;

    const sendGts = 7001308;
    const getGts = 7001309;
